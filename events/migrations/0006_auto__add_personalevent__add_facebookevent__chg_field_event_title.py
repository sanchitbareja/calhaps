...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'events_personalevent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fbEvent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.FacebookEvent'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User'])),
            ('rsvpStatus', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'events', ['PersonalEvent'])

        # Adding model 'FacebookEvent'
        db.create_table(u'events_facebookevent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fbId', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
        ...
        db.alter_column(u'events_event', 'title', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Deleting model 'PersonalEvent'
        db.delete_table(u'events_personalevent')
        ...
        # Changing field 'Event.title'
        db.alter_column(u'events_event', 'title', self.gf('django.db.models.fields.CharField')(max_length=300))
